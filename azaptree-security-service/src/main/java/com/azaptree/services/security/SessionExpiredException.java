...
public class SessionExpiredException extends UnknownSessionException {
	...
	public SessionExpiredException(final String message, final Throwable cause, final boolean enableSuppression, final boolean writableStackTrace) {
